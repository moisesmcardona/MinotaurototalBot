...
Public Class Form1
    ...
    Private Async Function OnGuildMemberAdd(ByVal e As GuildMemberAddEventArgs) As Task Handles DiscordClient.GuildMemberAdded
        Await DiscordClient.SendMessageAsync(Await DiscordClient.GetChannelAsync(421973555639615492), "Démosle una cordiál bienvenida a " & e.Member.Mention & " al Discord de MINOTAUROTOTAL. Usa el comando !bot para saber mis comandos :smiley:")
    End Function
    ...
    Private Async Function OnMessage(ByVal e As MessageCreateEventArgs) As Task Handles DiscordClient.MessageCreated
        ...
        If e.Message.Author.Username = "MythologyBot" = False Then
            If e.Channel.Id = 421973555639615492 Then 'MINOTAUROTOTAL
                ...
                End If
            End If
            'canal precios criptomonedas
            If e.Channel.Id = 432623865571704832 Then
                ...
                End If
            End If
            '421973555639615492 = general
            If e.Channel.Id = 421973555639615492 Then
